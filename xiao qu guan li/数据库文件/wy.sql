...
CREATE TABLE `car`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '车位号',
  `size` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '面积',
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '类型',
  `user` bigint(20) NULL DEFAULT NULL COMMENT '所属业主',
  `time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '到期时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '车位信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of car
-- ----------------------------
INSERT INTO `car` VALUES (1, '8723', '20.01', '标准车位', 8, '2021-01-09 22:38:59');
INSERT INTO `car` VALUES (2, '918JK', '20', '子母车位', 9, '2021-05-29');
INSERT INTO `car` VALUES (3, 'C区12', '12', '微型车位', 11, '2021-12-20');
...
CREATE TABLE `fix`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '报修标题',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '详情',
  `user` bigint(20) NULL DEFAULT NULL COMMENT '报修人',
  `state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '物业完成状态',
  `ustate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用户确认状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '报修信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `house`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '楼栋信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `record`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '收费名称',
  `price` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '金额',
  `time` datetime NULL DEFAULT NULL COMMENT '缴费截止时间',
  ...
  `state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '缴费状态',
  `gmtTime` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '缴费时间' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of record
-- ----------------------------
INSERT INTO `record` VALUES (3, '1', '1', '2021-01-01 22:49:27', 8, '1', '已缴费', '2021-01-02 22:49:31');
INSERT INTO `record` VALUES (4, '垃圾费8元', '8', '2021-01-01 23:12:22', 9, '一起缴纳哈', '待缴费', '2021-01-09 23:12:27');
INSERT INTO `record` VALUES (5, '垃圾费8元', '8', '2021-01-10 23:12:22', 8, '一起缴纳哈', '待缴费', '2021-01-11 23:12:27');
INSERT INTO `record` VALUES (6, '张大鹏的维修费', '12', '2021-01-11 23:12:38', 9, '12', '待缴费', '2021-01-12 23:12:40');
...
CREATE TABLE `room`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '房间信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 60 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES (57, 'admin', '保存用户', 'com.learn.controller.SysUserController.save()', '{\"email\":\"123@qq.com\",\"mobile\":\"17562307526\",\"roleIdList\":[1],\"status\":1,\"username\":\"zhangmaowen\"}', '127.0.0.1', '2021-02-20 19:58:43');
INSERT INTO `sys_log` VALUES (58, 'admin', '修改用户', 'com.learn.controller.SysUserController.update()', '{\"createTime\":1549533783000,\"email\":\"1289367@qq.com\",\"mobile\":\"13354260932\",\"roleIdList\":[1],\"status\":1,\"userId\":8,\"username\":\"李胜\"}', '127.0.0.1', '2021-02-20 21:04:17');
INSERT INTO `sys_log` VALUES (59, 'admin', '保存用户', 'com.learn.controller.SysUserController.save()', '{\"email\":\"1447628qq.com\",\"mobile\":\"1234567\",\"roleIdList\":[1],\"status\":1,\"username\":\"张三\"}', '127.0.0.1', '2021-02-20 21:04:55');
...
) ENGINE = InnoDB AUTO_INCREMENT = 98 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单管理' ROW_FORMAT = Dynamic;
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '普通', NULL, 1, '2021-01-17 10:26:34');
INSERT INTO `sys_role` VALUES (2, '系统管理员', NULL, -1, '2021-01-17 15:24:04');
...
CREATE TABLE `sys_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 166 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色与菜单对应关系' ROW_FORMAT = Dynamic;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (-1, 'admin', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', 'root@renren.io', '321321', 1, NULL, '2021-01-01 11:11:11', NULL, NULL);
INSERT INTO `sys_user` VALUES (1, 'admin1', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', 'admin@admin.com', '13612345678', 1, NULL, '2021-01-02 11:11:11', NULL, NULL);
INSERT INTO `sys_user` VALUES (8, '李四', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', '1289367@qq.com', '13354260932', 1, NULL, '2021-02-07 18:03:03', NULL, NULL);
INSERT INTO `sys_user` VALUES (9, '王二', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', '123123@qq.com', '13223232323', 1, -1, '2021-02-18 23:10:16', NULL, 4);
INSERT INTO `sys_user` VALUES (10, '马子', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', '123@qq.com', '17562307526', 1, -1, '2021-02-20 19:58:44', NULL, NULL);
INSERT INTO `sys_user` VALUES (11, '张三', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', '1447628qq.com', '1234567', 1, -1, '2021-02-20 21:04:55', NULL, NULL);
...
INSERT INTO `sys_user_role` VALUES (13, 10, 1);
...
CREATE TABLE `ts`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '投诉标题',
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '详情',
  `user` bigint(20) NULL DEFAULT NULL COMMENT '投诉人',
  `state` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '物业完成状态',
  `ustate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用户确认状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '投诉信息' ROW_FORMAT = Dynamic;
